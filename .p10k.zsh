# Generated by Powerlevel10k configuration wizard on 2022-07-31 at 17:32 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%117F'   # green foreground
      local   modified='%122F'  # yellow foreground
      local  untracked='%177F'   # blue foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=117
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=122
